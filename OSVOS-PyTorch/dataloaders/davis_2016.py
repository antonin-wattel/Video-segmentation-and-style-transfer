...
class DAVIS2016(Dataset):
    ...
    def __init__(self, train=True,
                 ...
                 db_root_dir="C:/Users/A1234/Documents/INF573/project/OSVOS-PyTorch/DAVIS-data/DAVIS",
                 transform=None,
        ...
        #db_root_dir = "C:/Users/A1234/Documents/INF573/project/OSVOS-PyTorch/DAVIS-data/DAVIS"#forced
    ...
    def make_img_gt_pair(self, idx):
        ...
        if self.inputRes is not None:
            ...
            if self.labels[idx] is not None:
                label = cv2.resize(label, self.inputRes, interp='nearest')
...
if __name__ == '__main__':
    ...
    dataset = DAVIS2016(db_root_dir="C:/Users/A1234/Documents/INF573/project/OSVOS-PyTorch/DAVIS-data/DAVIS",
                        train=True, transform=transforms)                    
