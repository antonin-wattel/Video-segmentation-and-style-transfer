...
STYLE_WEIGHT = 50 # 25
ADAM_LR = 0.001
#SAVE_MODEL_PATH = "transforms/mosaic.pth"
...
def train(args=None):
    ...
    save_model_path_final = ('transforms', '{}.pth'.format('multicolor'))#automatize this
    RAIN_IMAGE_SIZE = 256
    DATASET_PATH = "dataset"
    NUM_EPOCHS = 1
    STYLE_IMAGE_PATH = "images/mosaic.jpg"
    ...
    if args is not None:
        NUM_EPOCHS, DATASET_PATH, STYLE_IMAGE_PATH, SAVE_CHECKPOINTS, SAVE_MODEL_PATH, SAVE_IMAGE_PATH, SAVE_MODEL_EVERY, PLOT_LOSS, SHOW_IMAGE = args
    ...
    ###
    #TransformerNetwork = experimental.TransformerResNextNetwork().to(device)
    #TransformerNetwork = experimental.TransformerResNextNetwork_Pruned().to(device)
    ###
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        for content_batch, _ in train_loader:
            ...
            if (((batch_count-1)%SAVE_MODEL_EVERY == 0) or (batch_count==NUM_EPOCHS*len(train_loader))):
                ...
                sample_image_path = SAVE_CHECKPOINTS + "sample0_" + str(batch_count-1) + ".png"
    ...
    ###
    print("Saving TransformerNetwork weights at {}".format(SAVE_MODEL_PATH))
